...
void UserLayer::handleMessage(cMessage *msg){ // Handles incoming messages
        if(msg == testMsg){
            ...
            basicProtocolModule->powerOn_drone(1, 350, 350, z_val);
            basicProtocolModule->powerOn_drone(2, 0, 0, z_val);
            basicProtocolModule->powerOn_drone(3, 4000, 0, z_val);
            ...
            scheduleAt(simTime()+20, testMsg2);
            //delete(moveEV);
        }
        else if(msg == moveEV2){
